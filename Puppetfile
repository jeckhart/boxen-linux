...
github "gcc",         "0.0.3", :repo => "wrose/puppet-gcc"
...
github "repository",  "2.2.2", :repo => "wrose/puppet-repository"
...
github "python",      "1.3.2", :repo => "wrose/puppet-python"
github "mercurial",   "0.0.4", :repo => "wrose/puppet-mercurial"
#github "chrome",      "1.1.2", :repo => "wrose/puppet-chrome"
#github "firefox",     "1.2.1", :repo => "wrose/puppet-firefox"
#github "tmux",        "1.0.2", :repo => "wrose/puppet-tmux"
#github "pgadmin3",	   "1.0.0", :repo => "wrose/puppet-pgadmin3"
github "intellij",    "1.5.2", :repo => "wrose/puppet-intellij"
githut "spotify",     "1.0.2"
#github "iterm2",      "1.1.2"
#github "flux",        "1.0.0"
